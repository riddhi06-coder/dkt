                        ...
                        <div class="row g-3">    
                            ...
                            <div class="tab-content" id="wizard-tabContent">
                               ...
                               <form class="row g-3 needs-validation custom-input" 
                                    novalidate 
                                    action="{{ route('manage-products.update', $category->id) }}" 
                                    method="POST" 
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <input class="form-control" 
                                            ...
                                            type="text" 
                                            name="product_name" 
                                            value="{{ old('product_name', $category->product_name) }}" 
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="mt-2">
                                            <img id="thumbnailPreview" 
                                                src="{{ !empty($category->thumbnail_image) ? asset('uploads/products/'.$category->thumbnail_image) : '#' }}" 
                                                alt="Preview" 
                                                class="img-fluid rounded border {{ !empty($category->thumbnail_image) ? '' : 'd-none' }}" 
