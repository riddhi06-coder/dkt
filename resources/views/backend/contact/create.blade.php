                                ...
                                <div class="tab-pane fade show active" id="wizard-contact" role="tabpanel" aria-labelledby="wizard-contact-tab">
                                    <form class="row g-3 needs-validation custom-input" novalidate action="{{ route('manage-contact-details.store') }}" method="POST" enctype="multipart/form-data">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <input class="form-control" id="other_contact_number" type="text" name="other_contact_number" placeholder="Enter Contact Number" required pattern="^\+?[0-9]{1,4}?[-. ]?(\(?\d{1,3}?\)?[-. ]?)?[\d]{1,4}[-. ]?[\d]{1,4}[-. ]?[\d]{1,9}$"  maxlength="12">
                                            <div class="invalid-feedback">Please enter a valid Contact Number.</div>
                                        </div>
