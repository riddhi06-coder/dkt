            ...
            <div class="page-title">
              <div class="row">
                ...
                <ol class="breadcrumb">
                    ...
                    <a href="{{ route('manage-contact-details.index') }}">Home</a>
                    </li>
                            ...
                            <div class="tab-content" id="wizard-tabContent">
                                <div class="tab-pane fade show active" id="wizard-contact" role="tabpanel" aria-labelledby="wizard-contact-tab">
                                    <form class="row g-3 needs-validation custom-input" 
                                        novalidate 
                                        action="{{ route('manage-contact-details.update', $contact->id) }}" 
                                        method="POST" 
                                        ...
                                        <div class="col-md-12">
                                            ...
                                            <input class="form-control" id="i_frame" type="text" name="i_frame"
                                                value="{{ old('i_frame', $contact->i_frame) }}"
                                                placeholder="Enter I Frame URL" required>
                                            <div class="invalid-feedback">Please enter an I Frame URL.</div>
                                        </div>
                                                ...
                                                <tbody id="social-media-table-body">
                                                    @forelse($contact_details as $index => $social)
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <input type="url" name="social_media[{{ $index }}][link]" class="form-control"
                                                                    value="{{ $social['link'] ?? '' }}" placeholder="Enter Social Media URL" required>
                                                            </td>
                                                            <td>
                                                    ...
                                                    @empty
                                                        <!-- If no social media exists, keep 1 blank row -->
                                                        <tr>
                                                            <td>
                                                            ...
                                                            <td>
                                                                <input type="url" name="social_media[0][link]" class="form-control" placeholder="Enter Social Media URL" required>
                                                            </td>
                                                            <td>
                                                                <button type="button" class="btn btn-danger remove-social-media-row">Remove</button>
                                                            </td>
