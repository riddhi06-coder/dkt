                        ...
                        <div class="row g-3">    
                            ...
                            <div class="tab-content" id="wizard-tabContent">
                                <div class="tab-pane fade show active" id="wizard-contact" role="tabpanel" aria-labelledby="wizard-contact-tab">
                                    <form class="row g-3 needs-validation custom-input" novalidate action="{{ route('manage-home-banner-details.store') }}" method="POST" enctype="multipart/form-data">
                                        @csrf
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <input class="form-control" id="banner_video" type="file" name="banner_video" 
                                                accept=".mp4,.webm,.ogg" onchange="previewVideo(event)" required>
                                            <small class="text-secondary"><b>Note: Max size 3MB. Only MP4, WebM, or OGG allowed.</b></small>

                                            <!-- Video Preview -->
                                            <div class="mt-2">
                                                <video id="videoPreview" class="d-none rounded border" controls autoplay muted playsinline
