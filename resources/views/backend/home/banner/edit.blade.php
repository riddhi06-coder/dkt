                            ...
                            <div class="tab-content" id="wizard-tabContent">
                                <div class="tab-pane fade show active" id="wizard-contact" role="tabpanel" aria-labelledby="wizard-contact-tab">
                                   <form class="row g-3 needs-validation custom-input" novalidate
                                        action="{{ route('manage-home-banner-details.update', $banner->id) }}"
                                        method="POST"
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <input class="form-control" id="banner_heading" type="text" name="banner_heading" 
                                                value="{{ old('banner_heading', $banner->banner_heading) }}" required>
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <div class="mt-2">
                                                <img id="thumbnailPreview" 
                                                    src="{{ $banner->thumbnail ? asset('uploads/home/'.$banner->thumbnail) : '#' }}" 
                                                    class="img-fluid rounded border {{ $banner->thumbnail ? '' : 'd-none' }}" 
                                        ...
                                        <!-- Video Upload -->
                                        <div class="col-md-6">
                                            <label class="form-label" for="banner_video">Banner Video <span class="txt-danger">*</span></label>
                                            <input class="form-control" id="banner_video" type="file" name="banner_video" 
                                                accept=".mp4,.webm,.ogg" onchange="previewVideo(event)">
                                            <small class="text-secondary"><b>Note: Max size 3MB. MP4, WebM, OGG allowed.</b></small>

                                            <!-- Video Preview -->
                                            <div class="mt-2">
                                                <video id="videoPreview" 
                                                    src="{{ $banner->banner_video ? asset('uploads/home/'.$banner->banner_video) : '' }}" 
                                                    class="rounded border {{ $banner->banner_video ? '' : 'd-none' }}" 
                                        ...
                                        <div class="col-md-12">
                                            ...
                                            <textarea name="description" id="editor" class="form-control" rows="4" required>{{ old('description', $banner->description) }}</textarea>
                                            <div class="invalid-feedback">Please enter a description.</div>
                                        </div>

                                        <!-- Form Actions -->
                                        <div class="col-12 text-end">
                                            <a href="{{ route('manage-home-banner-details.index') }}" class="btn btn-danger px-4">Cancel</a>
