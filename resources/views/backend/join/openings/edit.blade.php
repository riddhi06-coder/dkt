                            ...
                            <div class="tab-content" id="wizard-tabContent">
                                <div class="tab-pane fade show active" id="wizard-contact" role="tabpanel" aria-labelledby="wizard-contact-tab">
                                  <form class="row g-3 needs-validation custom-input" novalidate 
                                        action="{{ route('manage-job-openings.update', $intro->id) }}" 
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <input class="form-control" id="job_role" type="text" name="job_role" 
                                                placeholder="Enter Job Role" value="{{ old('job_role', $intro->job_role) }}" required>
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <input class="form-control" id="job_location" type="text" name="job_location" 
                                                placeholder="Enter Job Location" value="{{ old('job_location', $intro->job_location) }}" required>
                                        ...
                                        <div class="col-md-12">
                                            ...
                                            <textarea name="description_main" id="summernote" class="form-control" rows="4" 
                                                    placeholder="Enter description" required>{{ old('description_main', $intro->description_main) }}</textarea>
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <div class="mt-2">
                                                @if($intro->job_pdf)
                                                    <embed id="pdf_preview" src="{{ asset('uploads/jobs/'.$intro->job_pdf) }}" 
                                                        type="application/pdf" style="width:100%; height:200px; border:1px solid #ddd;">
                                                @else
                                                    <embed id="pdf_preview" src="#" type="application/pdf" class="d-none" 
